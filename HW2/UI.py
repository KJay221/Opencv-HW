...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.Confidence.setGeometry(QtCore.QRect(530, 20, 200, 30))
        self.Confidence.setObjectName("Confidence")
        self.PredictionLabel = QtWidgets.QLabel(Form)
        self.PredictionLabel.setGeometry(QtCore.QRect(530, 50, 200, 30))
        self.PredictionLabel.setObjectName("PredictionLabel")
        self.Label = QtWidgets.QLabel(Form)
        self.Label.setGeometry(QtCore.QRect(530, 80, 200, 30))
